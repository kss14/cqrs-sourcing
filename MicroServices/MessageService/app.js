...
Sentry.init({
  dns: "http://20693beffe4f499aabfef7bdfd8ef3e2@glitchtip.kmp.com:8000/1",
});
...
app.get("/api/v1/messages/query", async (req, res) => {
  const query = new GetMessagesByOrderOfMostRecentQuery(
    JSON.parse(atob(req.query.data))
  );
...
app.get("/debug-sentry", function mainHandler(req, res) {
  console.log("http://20693beffe4f499aabfef7bdfd8ef3e2@glitchtip.kmp.com:8000/1");
  myUndefinedFunction();
